        ...
        <nav className="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul className="nav">
                  ...
                  >
                    ...
                    >
                      <div className="preview-thumbnail">
                        <div className="preview-icon bg-dark rounded-circle">
                          <i
                            className="fa fa-lock text-info"
                            aria-hidden="true"
                          ></i>
                        </div>
                      </div>
                    ...
                    >
                      <div className="preview-thumbnail">
                        <div className="preview-icon bg-dark rounded-circle">
                          <i
                            className="fa fa-calendar-check text-success"
                            aria-hidden="true"
                          ></i>
                        </div>
                      </div>
            ...
            <li className="nav-item menu-items">
              <div
                className="nav-link"
                onClick={() => setUserPagesOpen(!userPagesOpen)}
                aria-expanded={userPagesOpen}
              >
                <span className="menu-icon">
              ...
              <div
                className={userPagesOpen ? "collapse show" : "collapse"}
                id="auth"
              >
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item">
                    <Link className="nav-link" to="kitc/blank-page">
                      Blank Page
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" to="kitc/error-404">
                      404
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" to="kitc/error-500">
                      500
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" to="kitc/login">
                      Login
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" to="kitc/register">
                      Register
                    </Link>
                  </li>
                </ul>
            ...
            <li className="nav-item menu-items">
              <Link className="nav-link" to="/kitchen/all-dishes">
                <span className="menu-icon">
                    ...
                    <div className="card-body py-0 px-0 px-sm-3">
                      <div className="row align-items-center">
                        <div className="col-4 col-sm-3 col-xl-2">
                          <img
                            src="/images/dashboard/Group126@2x.png"
